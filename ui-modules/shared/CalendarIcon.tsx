...
export function CalendarIcon({
  ...
  return (
    ...
    >
      <defs>
        <style>
          .cls-1 {"fill:none;stroke:"+ iconColor +";stroke-miterlimit:10;stroke-width:1.91px;"}
        </style>
      </defs>
      ...
      <polyline className="cls-1" points="6.26 12.94 10.09 12.94 10.09 15.8 7.22 15.8 7.22 18.67 11.04 18.67" />
