...
import { insertInspections, insertPropertyListing } from "/app/client/library-modules/domain-models/property-listing/repositories/listing-repository";
...
export const submitForm = createAsyncThunk(
  ...
  async (propertyFormData: FormSchemaType) => {
    ...
    const inspectionIds = await insertInspections(
