...
import { selectIsEditing, selectProfileData, setEditing, updateField } from "../state/profile-slice";
...
export function EditableAvatar({imageUrl, editing, onImageChange}: EditableAvatarProps) {
    ...
    return (
        ...
        <input type="file" accept="image/*" ref={fileInputRef} onChange={handleUpdate} className='hidden'/>
